...
public class Middleware {
	...
	public enum MiddlewareCrashType{
	    CRASH_BEFORE_SEND_BOTE_REQUEST(1),
	    CRASH_AFTER_SENDING_VOTE_REQUEST_AND_BEFORE_RECEIVING_ANY_REPLIES(2),
	    CRASH_AFTER_RECEIVING_SOME_REPLIES_BUT_NOT_ALL(3), //hard to implement this one
	    CRASH_AFTER_RECEIVING_ALL_REPLIES_BUT_BEFORE_DECIDING(4),
	    CRASH_AFTER_DECIDING_BUT_BEFORE_SENDING_DECISION(5),
	    CRASH_AFTER_SENDING_SOME_BUT_NOT_ALL_DECISIONS(6), //hard to implement this one
	    CRASH_AFTER_HAVING_SENT_ALL_DECISIONS(7),
	    NO_CRASH(0)
	}
