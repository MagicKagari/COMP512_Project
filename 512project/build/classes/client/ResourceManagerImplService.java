 ...
 * 
 */
@WebServiceClient(name = "ResourceManagerImplService", targetNamespace = "comp512", wsdlLocation = "http://localhost:8080/rm/service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RESOURCEMANAGERIMPLSERVICE_QNAME = new QName("comp512", "ResourceManagerImplService");
    ...
    public ResourceManager getResourceManagerImplPort() {
        return super.getPort(new QName("comp512", "ResourceManagerImplPort"), ResourceManager.class);
    }
    ...
    public ResourceManager getResourceManagerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("comp512", "ResourceManagerImplPort"), ResourceManager.class, features);
    }
