 ...
 * 
 */
@WebServiceClient(name = "ResourceManagerImplService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:15081/rm/service?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:15081/rm/service?wsdl");
